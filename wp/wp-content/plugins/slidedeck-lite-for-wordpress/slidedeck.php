...
function slidedeck_print_scripts() {
    ...
    wp_register_script( 'slidedeck-library-js', slidedeck_url( '/lib/slidedeck.jquery.lite.js' ), array( 'jquery' ), SLIDEDECK_VERSION );
...
function slidedeck_dynamic_template_content( $slidedeck, $slides ) {
    ...
    foreach ( (array) $slides as $slide ) {
        ...
        $template_str.= '<li><a href="#' . $i . '" class="sd-node-nav-link"><span class="sd-node-nav-link-label-title">' . $title_substr . '</span></a></li>';
        $i++;
    }
